# Generated by Django 5.2.3 on 2025-11-18 10:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chama_contribution_amount', models.DecimalField(decimal_places=2, max_digits=8)),
                ('chama_payment_method', models.CharField(choices=[('none', 'None'), ('paybill', 'Paybill'), ('till', 'Till Number')], default='none', max_length=10)),
                ('chama_paybill_number', models.CharField(blank=True, max_length=6, null=True)),
                ('chama_paybill_name', models.CharField(blank=True, max_length=50, null=True)),
                ('chama_paybill_account_number', models.CharField(blank=True, max_length=20, null=True)),
                ('chama_till_number', models.CharField(blank=True, max_length=6, null=True)),
                ('chama_till_name', models.CharField(blank=True, max_length=50, null=True)),
                ('chama_contribution_frequency', models.CharField(choices=[('weekly', 'Weekly'), ('monthly', 'Monthly'), ('custom', 'Custom')], default='monthly', max_length=7)),
